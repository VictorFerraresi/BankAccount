 ...
 * @author Victor
 */
public class updatePostStudentGUI extends javax.swing.JFrame {

    /**
     * Creates new form updatePostStudentGUI
     */
    public updatePostStudentGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Atualização de Postgraduate Student");
        ...
        jLabel6.setText("Nova Tese do Estudante");

        jLabel7.setText("Novo Supervisor do Estudante");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatePostStudentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatePostStudentGUI().setVisible(true);
            }
        });
    }
