 ...
 * @author Victor
 */
public class createPostStudentGUI extends javax.swing.JFrame {

    /**
     * Creates new form createPostStudentGUI
     */
    public createPostStudentGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Criação de Postgraduate Student");
        ...
        jLabel6.setText("Tema da Tese do Estudante");

        jLabel7.setText("Supervisor do Estudante");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Instance poststudent with info
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(createPostStudentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new createPostStudentGUI().setVisible(true);
            }
        });
    }
